...
namespace WebGallery
{
    public class RouteConfig
    {
        public static void RegisterRoutes(RouteCollection routes)
        {
            ...
            routes.MapRoute(name: SiteRouteNames.App_Rebrand, url: SiteRouteUrlPatterns.App_Rebrand, defaults: new { controller = manage, action = nameof(ManageController.RebrandApp) });
            ...
            routes.MapRoute(name: SiteRouteNames.Submitter_Msa_Update, url: SiteRouteUrlPatterns.Submitter_Msa_Update, defaults: new { controller = manage, action = nameof(ManageController.UpdateMsa) });
    ...
    public class SiteRouteUrlPatterns
    {
        ...
        public const string App_Rebrand = "admin/apps/in/feed/{appId}/rebrand";
        ...
        public const string Submitter_Msa_Update = "admin/submitters/{submitterId}/msa/update";
    ...
    public class SiteRouteNames
    {
        ...
        public const string App_Rebrand = nameof(App_Rebrand);
        ...
        public const string Submitter_Msa_Update = nameof(Submitter_Msa_Update);
